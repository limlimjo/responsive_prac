...
const Intro = ({ isDesktop, isTablet, isMobile }) => {
    return (
        <>
...
export const Desktop = () => <Intro isDesktop={true} isTablet={false} isMobile={false} />;
export const Tablet = () => <Intro isDesktop={false} isTablet={true} isMobile={false} />;
export const Mobile = () => <Intro isDesktop={false} isTablet={false} isMobile={true} />;
