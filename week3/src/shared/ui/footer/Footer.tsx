...
const Footer = ({ isDesktop, isTablet, isMobile }) => {
    return (
...
export const Desktop = () => <Footer isDesktop={true} isTablet={false} isMobile={false} />;
export const Tablet = () => <Footer isDesktop={false} isTablet={true} isMobile={false} />;
export const Mobile = () => <Footer isDesktop={false} isTablet={false} isMobile={true} />;
